...
The API uses by default the [TabPFN-2.5](/models) model. There are options to specify a model checkpoint from the list of available checkpoints on [HuggingFace](https://huggingface.co/Prior-Labs/tabpfn_2_5/tree/main) and set it using the `model_path` parameter. Please refer to the [Predict](/api-reference/prediction/run-predictions) endpoint documentation for detailed instructions.
