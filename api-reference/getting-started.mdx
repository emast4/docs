...
The Prior Labs API provides secure, cloud-hosted access to TabPFN, enabling you to run zero-shot classification and regression at scale - without managing GPUs or infrastructure.
...
- **Daily Limit**: Total of 50 million cells per day
...
For questions about authentication, access tokens, or API onboarding, contact us at:
