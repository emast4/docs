...
description: "Generate realistic synthetic tabular data with TabPFN in seconds."
---
...
![Data generation example](/public/datagen.png)

The unsupervised module in `tabpfn-extensions` provides built-in support for synthetic data generation through the [`TabPFNUnsupervisedModel`](https://github.com/PriorLabs/tabpfn-extensions/blob/main/src/tabpfn_extensions/unsupervised/unsupervised.py).
