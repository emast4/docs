...
Use the [`TabPFNUnsupervisedModel`](https://github.com/PriorLabs/tabpfn-extensions/blob/main/src/tabpfn_extensions/unsupervised/unsupervised.py) from `tabpfn-extensionrs` to get started.
