...
TabPFN extends beyond tabular and regression tasks - it can perform **zero-shot time series forecasting** by reframing forecasting as a tabular regression problem. Our method, **TabPFN-TS**, combines the TabPFN model with lightweight feature engineering to deliver both **point** and **probabilistic** forecasts instantly, without any retraining.
