...
- **Lightweight & Fast**: Achieves state-of-the-art results with a highly compact \<20M parameter model (40× smaller than some foundation models), enabling rapid inference on a local CPU or via the `tabpfn-client` with **no GPU required**.
