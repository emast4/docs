...
The **Embeddings** extension enables extraction of **latent feature representations** (embeddings) from TabPFN models. These embeddings provide a powerful way to analyze, visualize, or reuse the learned representations produced by TabPFN’s transformer architecture - useful for tasks such as clustering, feature analysis, or meta-learning.
