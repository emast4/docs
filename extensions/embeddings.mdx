...
The extension supports both **classification** and **regression** models and offers two embedding extraction modes:
...
<Warning>
  The embeddings extension is not compatible with the lightweight `tabpfn-client` package since the client does not expose internal model representations.
</Warning>
