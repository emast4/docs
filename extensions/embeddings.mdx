...
- **Cross-validated embeddings** - extracted via _K_-fold cross-validation for improved generalization
...
<Card title="GitHub Code" icon="book" horizontal href="https://github.com/PriorLabs/tabpfn-extensions/tree/main/src/tabpfn_extensions/embedding">
