...
Traditional TabPFN models are zero-shot - they don’t require tuning for strong performance. However, for specific datasets, model variants, or evaluation goals, fine-tuning hyperparameters can further improve accuracy, calibration, and robustness. The HPO extension automates this process using a Bayesian search strategy that intelligently explores the parameter space to find the best-performing configuration.
