...
To install the extension, include the `post-hoc-ensembles` extras module:
...
```python
from tabpfn_extensions.post-hoc-ensembles.sklearn_interface import AutoTabPFNClassifier
