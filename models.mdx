...
TabPFN-2.5-Plus an improvement over TabPFN-2.5, expanding capabilities to also handle textual data without any pre-processing. You can try TabPFN-2.5-Plus [here](https://ux.priorlabs.ai/playground). TabPFN-2.5-Plus is only available via the API.
...
- Handles any text data, e.g. product names, reviews, insurance claim descriptions and others witout pre-processing.
