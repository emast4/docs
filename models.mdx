...
| :-------------- | :------- | :----------- | :----------- | :-------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------ |
| **TabPFN-2.5**  | 50,000   | 2,000        | Mixed        | [`TABPFN-2.5 License v1.0`](https://huggingface.co/Prior-Labs/tabpfn_2_5/blob/main/LICENSE)                                                                                                   | Documentation available soon                                        |
...
- **License:** Model checkpoint under: [`TABPFN-2.5 License v1.0`](https://huggingface.co/Prior-Labs/tabpfn_2_5/blob/main/LICENSE), code under [Prior Labs License](https://raw.githubusercontent.com/PriorLabs/TabPFN/49394b053a6759cfe68e90c21a2d51c31b396768/LICENSE) (Open source, commercial use with attribution)
