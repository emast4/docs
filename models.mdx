...
| :-------------- | :------- | :----------- | :----------- | :-------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------ |
| TabPFN-2.5  | 50,000   | 2,000        | Mixed        | [TABPFN-2.5 License v1.0](https://huggingface.co/Prior-Labs/tabpfn_2_5/blob/main/LICENSE)                                                                                                   | [Model report](https://priorlabs.ai/technical-reports/tabpfn-2-5-model-report)                                        |
