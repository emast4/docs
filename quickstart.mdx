...
<Info>
Please note that TabPFN-2.5 is available only for **non-commercial use** whereas TabPFN-2 available for any usage.
</Info>
...
We also provide a convinience method for listing the available models:
