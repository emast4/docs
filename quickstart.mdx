...
from tapfn_client.estimator import TabPFNClassifier
...
from tapfn_client.estimator import TabPFNRegressor
from tabpfn_client.constants import ModelVersion

# Set the version of the TabPFNRegressor to 2.5
classifier = TabPFNRegressor.get_default_for_version(ModelVersion.V2_5)
```
</CodeGroup>
